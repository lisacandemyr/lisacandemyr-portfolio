          ...
          <div className={`row ${toggleDarkMode ? "text-light-mode" : "text-dark-mode"}`}>
            ...
            <div className="col-lg-8">
              <p>
                ...
                <br />
                <em>
                The header icon is inspired by the imagined appearance of polyurethane at a microscopic level, enhanced with colors for added engagement. The subsequent icons are chosen to complement the first one, creating a cohesive and continuous aesthetic throughout the project. Once again, I've opted for a static page design, but this time with scrollable content. The colour palette has been updated to a more technological look, with elements styled using glassmorphism to truly capture the modern feel, departing from the company's traditional white and blue scheme. To add a bit of fun distinct from my previous project, I've added a hover glitch effect to the headline and implemented a more interactive menu.
                </em>
              </p>
